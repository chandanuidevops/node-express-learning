    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51LltdXSC7daSehImyGj0ELcavZKAgFq7mEw1eHGTENHRB0sQfxxduRj7hKZw8JdP5vK3Ha9TrUSsZvqsGYReEL1i00gpYTTPUq');
            _context.next = 4;
...
var formSelector = document.querySelector('.form--login');
